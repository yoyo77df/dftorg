...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "FFBPL MATCH — Premium Esports Tournament Platform" },
      ...
      { property: "og:title", content: "FFBPL MATCH — Premium Esports Tournament Platform" },
      ...
      { property: "og:site_name", content: "FFBPL MATCH" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "FFBPL MATCH — Premium Esports Tournament Platform" },
      ...
      { name: "apple-mobile-web-app-title", content: "FFBPL MATCH" },
    ],
    links: [
      {
        rel: "stylesheet",
